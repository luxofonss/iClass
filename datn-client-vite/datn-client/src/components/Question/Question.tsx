	...
	return (
		<div className={cx("question")}>
				...
				<div className={cx("info")}>
					...
					>
						<Select
							...
							onSelect={(value) =>
								onSelectType(value as TypeQuestion)
							}
						/>
					</Form.Item>
			...
			<div className={cx("options")}>
				<Form.Item
					name={[field.name, field.key, "image"]}
					label="Image"
				>
					<Input type="file" />
				</Form.Item>
				<Form.Item
					name={[field.name, field.key, "audio"]}
					label="Audio"
				>
					<Input type="file" />
				</Form.Item>
			...
			<Form.Item
				name={[field.name, field.key, "answer_explain"]}
				label="Explain the answer"
			>
				<SimpleEditor
					onValueChange={(value) => {
						form.setFieldValue(
							[field.name, field.key, "answer_explain"],
							value
						);
					}}

		...
		<div className={cx("home-wrapper")}>
				...
				<Row className={cx("container")}>
					<Col span={12} className={cx("heading")}>
						<Typography.Title level={1}>
							Hệ thống dạy và học trực tuyến cá nhân hóa cho giáo
							viên và học sinh
						</Typography.Title>
						<Typography.Paragraph>
							Learnify cung cấp các bài luyện thi, ôn tập chất
							lượng cao và đa dạng, phù hợp với tất cả các bạn học
							sinh, sinh viên..
						</Typography.Paragraph>
					</Col>
				</Row>
			...
			<section className={cx("section", "container")}>
				<div className={cx("heading")}>
					...
					<Typography.Paragraph>
						Với hệ thống khóa học chất lượng cao, nội dung đa dạng
						và chú trọng thực hành, trải nghiệm học tập của bạn tại
						Learnify sẽ thật sự tuyệt vời và hiệu quả.
					</Typography.Paragraph>
				</div>
				<Row gutter={[16, 16]}>
			...
			<section className={cx("section", "container")}>
				<div className={cx("heading")}>
					...
					<Typography.Paragraph>
						Sứ mệnh của Learnify là giúp cho các bạn học sinh, sinh
						viên có thể học và thi hiệu quả hơn dựa vào hệ thống
						phân tích cá nhân hóa chuyên sâu ứng dụng AI và Big
						Data.
					</Typography.Paragraph>
				</div>
				<Row gutter={[24, 24]}>

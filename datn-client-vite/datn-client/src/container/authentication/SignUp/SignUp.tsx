...
function SignUp() {
	...
	return (
		<Row className={cx("sign-up-wrapper")}>
			<Col span={12}>
				<div
					className={cx("flex-center", "banner")}
					style={{ backgroundImage: `url(${auth_banner})` }}
				></div>
			</Col>
			<Col span={12} className={cx("form")}>
				...
				<Form onFinish={onSubmit} form={form} layout="vertical">
					<div>
						{step === 1 && (
							<Typography.Text>
								Step 1/2: Enter your personal details below
							</Typography.Text>
						)}
						<Row gutter={12}>
							<Col span={12}>
					...
					<div>
						{step === 2 && (
							<Typography.Text>
								Step 2/2: Enter your studying information
							</Typography.Text>
						)}
						<Form.Item
							hidden={step === 1}
						...
						{type === "teacher" && (
							<Fragment>
								...
								<Form.Item
									hidden={step === 1}
									name={["teacher_info", "edu_qualification"]}
